...
<div align="center">
    <a href="https://zandaa.dev"><img src="https://img.shields.io/badge/Website-00E6FF?style=for-the-badge&logo=google-chrome&logoColor=white"/></a>
...
const Zandaa = {
    ...
    code: {
        languages: ["PHP", "SQL", "JavaScript", "HTML", "CSS", "Python", "Bootstrap"],
        tools: ["Laravel", "PWA", "Composer", "Node", "NPM"],
        learning: ["AI", "Machine Learning"]
    },
    interests: ["Web Development", "AI", "Open Source", "Gaming"]
};
```
